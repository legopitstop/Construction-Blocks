...
public class Beam extends FourWayBlock {
    private final VoxelShape[] renderShapes;

    public Beam(AbstractBlock.Properties properties) {
        //      Voxel Width       Num * Width       Voxel Height    Num * Height     Invis Voxel
        super(6.0F, 0.0F, 16.0F, 16.0F, 16.0F, properties);
        ...
        //                                   Voxel Width       Num * Width       Voxel Height     Num * Bottom      Num * Top
        this.renderShapes = this.makeShapes(6.0F, 0.0F, 16.0F, 16.0F, 16.0F);
    }
    ...
    private boolean func_235493_c_(Block p_235493_1_) {
        // block tags that it can connect to
        return p_235493_1_.isIn(BlockTags.FENCES) && p_235493_1_.isIn(BlockTags.WOODEN_FENCES) == this.getDefaultState().func_235714_a_(BlockTags.FENCES);
    }
